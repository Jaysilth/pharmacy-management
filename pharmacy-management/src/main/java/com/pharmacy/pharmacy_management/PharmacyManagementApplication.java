 ...
 *
 * @EnableScheduling — ADDED. Required for TokenRevocationService's daily purge
 * of expired revocation rows and LoginRateLimitFilter's periodic cleanup of
 * stale rate-limit entries. Without this, both @Scheduled methods are inert —
 * Spring silently never calls them, they don't error, they just never run,
 * and the tables/maps they clean up grow unbounded instead.
 */
